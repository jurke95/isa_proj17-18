...
INSERT INTO peca.user (id,email, role, password,name, surname,city,phonenumber, active, confirmationToken) VALUES (1,"user1","USER", "123","Marko","Juric","Novi Sad","065567554",1, "43");
